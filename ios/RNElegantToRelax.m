...
@interface RNElegantToRelax () <RCTCxxBridgeDelegate, RCTTurboModuleManagerDelegate> {
...
@implementation RNElegantToRelax

static RNElegantToRelax *instance = nil;
